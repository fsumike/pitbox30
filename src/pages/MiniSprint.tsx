  ...
  return (
    <div className="space-y-6">
      <div className="glass-panel p-6 bg-gradient-to-br from-pink-500/10 to-purple-500/10 dark:from-pink-500/20 dark:to-purple-500/20">
        <div className="mb-6">
          <h1 className="text-3xl font-bold mb-4 text-pink-600 dark:text-pink-400">Mini Sprint Cars</h1>
          <p className="text-gray-700 dark:text-gray-300">
            Mini Sprint Cars deliver exciting racing action in a compact package. These nimble machines feature motorcycle engines 
            and require precise tuning to maximize their performance potential. Use our comprehensive setup tools to track and 
            optimize your Mini Sprint's handling characteristics for consistent results on any track condition.
          </p>
        </div>
      ...
      <SetupSheet 
        title="Mini Sprint"
        carType="mini"
        description="Master your Mini Sprint car setup with detailed tracking of engine parameters, chassis adjustments, and suspension settings. Our comprehensive setup sheet helps you maintain consistent performance and make data-driven decisions."
