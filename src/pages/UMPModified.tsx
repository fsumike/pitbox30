...
function UMPModified() {
  ...
  // Define the setup data structure with UMP Modified specific sections
  const initialSetupData = {
    ...
    chassis: {
      chassis_manufacturer: { feature: '', comment: '' },
      chassis_year: { feature: '', comment: '' },
      chassis_type: { feature: '', comment: '' }
    },
    weight: {
      total_weight: { feature: '', comment: 'Minimum weight 2400 lbs with driver' },
    ...
    front_end: {
      ...
      spindle_length: { feature: '', comment: 'UMP legal spindle measurements' },
    ...
    suspension: {
      ...
      rear_suspension: { feature: '', comment: 'Type (three-link, four-link, etc.)' },
  ...
  return (
    <div className="space-y-6">
      <div className="glass-panel p-6 bg-gradient-to-br from-amber-500/10 to-yellow-500/10 dark:from-amber-500/20 dark:to-yellow-500/20">
        <div className="mb-6">
          <h1 className="text-3xl font-bold mb-4 text-amber-600 dark:text-amber-400">UMP Modified</h1>
          <p className="text-gray-700 dark:text-gray-300">
            UMP (United Midwestern Promoters) Modifieds are one of the most popular dirt track racing divisions in North America. 
            These cars feature specific rule requirements including weight limits, tire regulations, and suspension configurations. 
            Use our comprehensive setup tools to optimize your UMP Modified's performance while staying within class regulations.
          </p>
        </div>
      ...
      <SetupSheet 
        ...
        description="Track and optimize your UMP Modified setup with our detailed setup sheet. Monitor chassis adjustments, suspension settings, and tire data while ensuring compliance with UMP rules and regulations."
        ...
        sections={[
          ...
          {
            title: "Weight",
            fields: ["total_weight", "left_side_weight", "rear_weight", "corner_weights"]
          },
          {
            title: "Front End",
            fields: ["front_clip", "steering_box", "spindle_length", "bumpsteer", "ackermann"]
          },
          {
            title: "Suspension",
          ...
          {
            title: "Left Rear",
            fields: ["lr_spring", "lr_shock", "lr_ride_height", "lr_tube"]
          },
          {
            title: "Right Rear",
            fields: ["rr_spring", "rr_shock", "rr_ride_height", "rr_tube"]
          },
          {
            title: "Tires",
            fields: ["lf_tire", "rf_tire", "lr_tire", "rr_tire", "stagger"]
          },
          {
            title: "Engine",
            fields: ["engine_type", "displacement", "compression", "carburetor", "timing"]
          },
          {
            title: "Drivetrain",
            fields: ["transmission", "gear_ratio", "differential"]
          },
          {
            title: "Brake Bias",
          ...
          {
            title: "Notes",
            fields: ["track_notes", "setup_notes", "performance_notes"]
          }
        ]}
      />
    </div>
