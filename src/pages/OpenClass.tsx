...
function OpenClass() {
  ...
  // Define the setup data structure with Open Class specific sections
  const initialSetupData = {
    ...
    engine: {
      ...
      engine_type: { feature: '', comment: 'Engine type (Open Class)' },
      ...
      power_valve: { feature: '', comment: 'Power valve settings' },
      porting: { feature: '', comment: 'Cylinder porting modifications' },
      ignition: { feature: '', comment: 'Ignition system type' },
      ecu_mapping: { feature: '', comment: 'ECU mapping settings' }
    },
    drivetrain: {
    ...
    chassis_adjustments: {
      ...
      anti_roll_bar: { feature: '', comment: 'Anti-roll bar settings' },
      chassis_flex: { feature: '', comment: 'Chassis flex adjustments' }
    },
    safety: {
  ...
  return (
    <div className="space-y-6">
      <div className="glass-panel p-6 bg-gradient-to-br from-purple-500/10 to-pink-500/10 dark:from-purple-500/20 dark:to-pink-500/20">
        <div className="mb-6">
          <h1 className="text-3xl font-bold mb-4 text-purple-600 dark:text-purple-400">Open Class</h1>
          <p className="text-gray-700 dark:text-gray-300">
            The Open Class represents the highest level of competition with minimal restrictions on engine modifications and chassis setup. 
            These machines deliver maximum performance and are designed for experienced racers who demand the ultimate in speed and handling. 
            Use our comprehensive setup tools to fine-tune every aspect of your Open Class vehicle for peak performance across all track conditions.
          </p>
        </div>

        <div className="flex flex-col sm:flex-row gap-4 items-stretch">
          <LoadSetupsButton carType="open-class" onLoadSetup={handleLoadSetup} />
      ...
      <SetupSheet 
        title="Open Class"
        carType="open-class"
        description="Track and optimize your Open Class setup with our comprehensive setup sheet. Monitor chassis adjustments, engine settings, and suspension data to maximize performance and achieve the ultimate competitive edge."
        ...
        sections={[
          ...
          {
            title: "Chassis",
            fields: ["chassis_manufacturer", "chassis_year", "chassis_type", "wheelbase", "frame_stiffness"]
          },
          {
            title: "Weight",
          ...
          {
            title: "Engine",
            fields: ["engine_builder", "engine_type", "displacement", "compression_ratio", "carburetor", "jetting", "timing", "spark_plug", "fuel_type", "exhaust", "air_filter", "cooling_system", "power_valve", "porting", "ignition", "ecu_mapping"]
          },
          {
            title: "Drivetrain",
            fields: ["transmission", "clutch_type", "clutch_springs", "gear_ratio", "chain_size", "sprocket_front", "sprocket_rear"]
          },
          {
            title: "Chassis Adjustments",
            fields: ["front_torsion_bar", "rear_torsion_bar", "third_bearing_support", "seat_struts", "side_rails", "anti_roll_bar", "chassis_flex"]
          },
          {
            title: "Safety",
            fields: ["seat_position", "belts_condition", "arm_restraints", "helmet_fit", "neck_brace", "chest_protector", "fire_suit"]
          },
          {
            title: "Performance",
