...
function OpenIntermediate() {
  ...
  // Define the setup data structure with Open Intermediate specific sections
  const initialSetupData = {
    ...
    engine: {
      ...
      engine_type: { feature: '', comment: 'Engine type (Open Intermediate)' },
  ...
  return (
    <div className="space-y-6">
      <div className="glass-panel p-6 bg-gradient-to-br from-orange-500/10 to-amber-500/10 dark:from-orange-500/20 dark:to-amber-500/20">
        <div className="mb-6">
          <h1 className="text-3xl font-bold mb-4 text-orange-600 dark:text-orange-400">Open Intermediate Class</h1>
          <p className="text-gray-700 dark:text-gray-300">
            The Open Intermediate Class offers more flexibility in engine modifications compared to restricted classes, allowing racers to develop 
            their mechanical skills alongside driving abilities. These machines feature enhanced performance while maintaining a balanced approach 
            suitable for developing racers. Use our comprehensive setup tools to fine-tune your Open Intermediate kart for optimal performance 
            across various track conditions.
          </p>
        </div>

        <div className="flex flex-col sm:flex-row gap-4 items-stretch">
          <LoadSetupsButton carType="open-intermediate" onLoadSetup={handleLoadSetup} />
      ...
      <SetupSheet 
        title="Open Intermediate Class"
        carType="open-intermediate"
        description="Track and optimize your Open Intermediate Class setup with our comprehensive setup sheet. Monitor chassis adjustments, engine settings, and suspension data to maximize performance and consistency on the track."
        ...
        sections={[
          ...
          {
            title: "Engine",
            fields: ["engine_builder", "engine_type", "displacement", "compression_ratio", "carburetor", "jetting", "timing", "spark_plug", "fuel_type", "exhaust", "air_filter", "cooling_system", "power_valve", "porting"]
          },
          {
            title: "Drivetrain",
...
export default OpenIntermediate;
