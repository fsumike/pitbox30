  ...
  return (
    <div className="space-y-6">
      <div className="glass-panel p-6 bg-gradient-to-br from-orange-500/10 to-red-500/10 dark:from-orange-500/20 dark:to-red-500/20">
        <div className="mb-6">
          <h1 className="text-3xl font-bold mb-4 text-orange-600 dark:text-orange-400">Wingless Sprint Cars</h1>
          <p className="text-gray-700 dark:text-gray-300">
            Wingless Sprint Cars represent the purest form of sprint car racing, where driver skill and chassis setup are paramount. 
            Without the aerodynamic advantage of wings, these cars require precise handling characteristics and mechanical grip to perform at their best.
            Track your setup changes meticulously to master the art of wingless sprint car racing.
          </p>
        </div>

        <div className="flex flex-col sm:flex-row gap-4 items-stretch">
          <LoadSetupsButton carType="wingless" onLoadSetup={handleLoadSetup} />
      ...
      <SetupSheet 
        title="Wingless Sprint"
        carType="wingless"
        description="Optimize your wingless sprint car setup with detailed tracking of chassis adjustments, tire pressures, gear ratios, and suspension settings to find the perfect balance for any track condition."
...
export default WinglessSprints;
