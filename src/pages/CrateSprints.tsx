...
function CrateSprints() {
  ...
  return (
    <div className="space-y-6">
      <div className="glass-panel p-6 bg-gradient-to-br from-green-500/10 to-emerald-500/10 dark:from-green-500/20 dark:to-emerald-500/20">
        <div className="mb-6">
          <h1 className="text-3xl font-bold mb-4 text-green-600 dark:text-green-400">Crate Sprint Cars</h1>
          <p className="text-gray-700 dark:text-gray-300">
            Crate Sprint Cars offer an economical entry point into sprint car racing with sealed engines that ensure competitive racing and cost control. 
            These cars put a premium on chassis setup and driver ability, making them perfect for developing racing skills and understanding car dynamics.
            Use our setup tools to gain the competitive edge in this growing class.
          </p>
        </div>

        <div className="flex flex-col sm:flex-row gap-4 items-stretch">
          <LoadSetupsButton carType="crate" onLoadSetup={handleLoadSetup} />
      ...
      <SetupSheet 
        title="Crate Sprint"
        carType="crate"
        description="Fine-tune your crate sprint car setup to maximize performance within class regulations. Track every adjustment to understand what works best for your driving style and track conditions."
