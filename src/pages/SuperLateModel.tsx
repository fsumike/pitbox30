...
function SuperLateModel() {
  ...
  const initialSetupData = {
    general: {
      ...
      class: { feature: 'Super', comment: 'Super Late Model' },
      date: { feature: new Date().toISOString().split('T')[0], comment: '' }
    },
    weight_balance: {
      total_weight: { feature: '', comment: '2300-2500 lbs typical for Super' },
    ...
    front_suspension: {
      lf_spring_rate: { feature: '', comment: '300-450 lbs/in typical for Super' },
      rf_spring_rate: { feature: '', comment: '300-450 lbs/in typical for Super' },
    ...
    rear_suspension: {
      ...
      lr_spring_rate: { feature: '', comment: '225-375 lbs/in typical for Super' },
      rr_spring_rate: { feature: '', comment: '225-375 lbs/in typical for Super' },
  ...
  return (
    <div className="space-y-6">
      <div className="glass-panel p-6 bg-gradient-to-br from-red-600/10 to-orange-600/10 dark:from-red-600/20 dark:to-orange-600/20">
        <div className="mb-6">
          <h1 className="text-3xl font-bold mb-4 text-red-700 dark:text-red-400">Super Late Model</h1>
          <p className="text-gray-700 dark:text-gray-300">
            Super Late Models are the premier class of dirt track racing, featuring unrestricted open engines with 800+ horsepower and
            the most advanced chassis technology. These high-performance machines demand precise setup optimization across all systems.
            Use this comprehensive setup sheet to document every critical adjustment for maximum performance.
          </p>
        </div>

        <div className="flex flex-col sm:flex-row gap-4 items-stretch">
          <LoadSetupsButton carType="super-late-model" onLoadSetup={handleLoadSetup} />
        </div>
      </div>
      ...
      <SetupSheet
        ...
        carType="super-late-model"
        description="Super Late Model setup documentation with comprehensive weight, suspension, and tire tracking for premier dirt racing."
