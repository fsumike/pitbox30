  ...
  return (
    <div className="space-y-6">
      <div className="glass-panel p-6 bg-gradient-to-br from-red-500/10 to-orange-500/10 dark:from-red-500/20 dark:to-orange-500/20">
        <div className="mb-6">
          <h1 className="text-3xl font-bold mb-4 text-red-600 dark:text-red-400">600 Micro Sprints</h1>
          <p className="text-gray-700 dark:text-gray-300">
            600cc Micro Sprints deliver intense racing action in a compact package. These powerful machines require precise tuning 
            and setup expertise to maximize their performance potential. From engine management to chassis setup, every detail 
            matters in the competitive world of Micro Sprint racing.
          </p>
        </div>

        <div className="flex flex-col sm:flex-row gap-4 items-stretch">
          <LoadSetupsButton carType="600" onLoadSetup={handleLoadSetup} />
      ...
      <SetupSheet 
        title="600 Micro Sprint"
        carType="600"
        description="Master your 600cc Micro Sprint setup with comprehensive tracking of engine parameters, chassis adjustments, and suspension settings. Our detailed setup sheet helps you maintain consistent performance and make data-driven decisions."
