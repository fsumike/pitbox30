...
function SportsmanClass() {
  ...
  // Define the setup data structure with Sportsman Class specific sections
  const initialSetupData = {
    ...
    engine: {
      ...
      engine_type: { feature: '', comment: 'Engine type (Sportsman Class)' },
  ...
  return (
    <div className="space-y-6">
      <div className="glass-panel p-6 bg-gradient-to-br from-teal-500/10 to-cyan-500/10 dark:from-teal-500/20 dark:to-cyan-500/20">
        <div className="mb-6">
          <h1 className="text-3xl font-bold mb-4 text-teal-600 dark:text-teal-400">Sportsman Class</h1>
          <p className="text-gray-700 dark:text-gray-300">
            The Sportsman Class offers a balanced approach to racing, with moderate regulations that allow for some performance enhancements while maintaining competitive parity. 
            These machines provide an excellent platform for developing racers to refine their skills and technical knowledge. 
            Use our comprehensive setup tools to fine-tune your Sportsman Class vehicle for optimal performance across various track conditions.
          </p>
        </div>

        <div className="flex flex-col sm:flex-row gap-4 items-stretch">
          <LoadSetupsButton carType="sportsman" onLoadSetup={handleLoadSetup} />
      ...
      <SetupSheet 
        title="Sportsman Class"
        carType="sportsman"
        description="Track and optimize your Sportsman Class setup with our comprehensive setup sheet. Monitor chassis adjustments, engine settings, and suspension data to maximize performance and consistency on the track."
        ...
        sections={[
          ...
          {
            title: "Engine",
            fields: ["engine_builder", "engine_type", "displacement", "compression_ratio", "carburetor", "jetting", "timing", "spark_plug", "fuel_type", "exhaust", "air_filter", "cooling_system"]
          },
          {
            title: "Drivetrain",
