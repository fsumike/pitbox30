...
function BModified() {
  ...
  // Define the setup data structure with B-Modified specific sections
  ...
  return (
    <div className="space-y-6">
      <div className="glass-panel p-6 bg-gradient-to-br from-blue-500/10 to-indigo-500/10 dark:from-blue-500/20 dark:to-indigo-500/20">
        <div className="mb-6">
          <h1 className="text-3xl font-bold mb-4 text-blue-600 dark:text-blue-400">B-Modified</h1>
          <p className="text-gray-700 dark:text-gray-300">
            B-Modifieds are a popular and competitive dirt track racing class that offers a balance between cost control and performance. 
            These cars feature specific rule requirements including weight limits, tire regulations, and suspension configurations designed to keep competition close. 
            Use our comprehensive setup tools to optimize your B-Modified's performance while staying within class regulations.
          </p>
        </div>

        <div className="flex flex-col sm:flex-row gap-4 items-stretch">
          <LoadSetupsButton carType="b-modified" onLoadSetup={handleLoadSetup} />
      ...
      <SetupSheet 
        title="B-Modified"
        carType="b-modified"
        description="Track and optimize your B-Modified setup with our detailed setup sheet. Monitor chassis adjustments, suspension settings, and tire data while ensuring compliance with class rules and regulations."
