  ...
  return (
    <div className="space-y-6">
      <div className="glass-panel p-6 bg-gradient-to-br from-red-500/10 to-orange-500/10 dark:from-red-500/20 dark:to-orange-500/20">
        <div className="mb-6">
          <h1 className="text-3xl font-bold mb-4 text-red-600 dark:text-red-400">Late Model Dirt Race Cars</h1>
          <p className="text-gray-700 dark:text-gray-300">
            Late Model Dirt Race Cars represent the pinnacle of full-bodied dirt track racing, featuring high-horsepower engines and sophisticated chassis designs. 
            These powerful machines require precise setup adjustments to maximize performance on different track conditions.
            Use our comprehensive setup tools to track and optimize your Late Model's handling characteristics for consistent results.
          </p>
        </div>

        <div className="flex flex-col sm:flex-row gap-4 items-stretch">
          <LoadSetupsButton carType="latemodel" onLoadSetup={handleLoadSetup} />
      ...
      <SetupSheet 
        title="Late Model Dirt"
        carType="latemodel"
        description="Track and analyze your Late Model Dirt setup with our detailed setup sheet. Record chassis adjustments, spring rates, shock settings and more to find the perfect balance for any track condition."
