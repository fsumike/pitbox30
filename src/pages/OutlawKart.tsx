...
function OutlawKart() {
  ...
  return (
    <div className="space-y-6">
      <div className="glass-panel p-6 bg-gradient-to-br from-indigo-500/10 to-purple-500/10 dark:from-indigo-500/20 dark:to-purple-500/20">
        <div className="mb-6">
          <h1 className="text-3xl font-bold mb-4 text-indigo-600 dark:text-indigo-400">Outlaw Kart Racing</h1>
          <p className="text-gray-700 dark:text-gray-300">
            Outlaw Karts deliver high-powered, intense racing action in a compact package. These scaled-down race cars 
            feature motorcycle engines and are known for their high power-to-weight ratio, making them both challenging 
            and exciting to drive. Use our comprehensive setup tools to fine-tune your Outlaw Kart's performance 
            characteristics for optimal results on any track condition.
          </p>
        </div>

        <div className="flex flex-col sm:flex-row gap-4 items-stretch">
          <LoadSetupsButton carType="outlaw" onLoadSetup={handleLoadSetup} />
      ...
      <SetupSheet 
        title="Outlaw Kart"
        carType="outlaw"
        description="Track and optimize your Outlaw Kart setup with our detailed setup sheet. Monitor engine parameters, chassis adjustments, and suspension settings to find the perfect balance for competitive racing."
