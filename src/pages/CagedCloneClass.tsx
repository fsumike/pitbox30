...
function CagedCloneClass() {
  ...
  // Define the setup data structure with Caged Clone Class specific sections
  const initialSetupData = {
    ...
    chassis: {
      ...
      frame_stiffness: { feature: '', comment: 'Frame stiffness adjustments' },
      cage_type: { feature: '', comment: 'Roll cage specifications' }
    },
    weight: {
    ...
    engine: {
      ...
      engine_type: { feature: '', comment: 'Clone engine specifications' },
      displacement: { feature: '', comment: 'Engine displacement (cc)' },
      ...
      fuel_type: { feature: '', comment: 'Fuel type and octane' },
      exhaust: { feature: '', comment: 'Exhaust type and configuration' },
      air_filter: { feature: '', comment: 'Air filter type' },
      cooling_system: { feature: '', comment: 'Cooling system setup' },
      governor: { feature: '', comment: 'Governor settings/removal' },
      flywheel: { feature: '', comment: 'Flywheel specifications' },
      cam_profile: { feature: '', comment: 'Camshaft profile' }
    },
    drivetrain: {
    ...
    chassis_adjustments: {
      ...
      cage_bracing: { feature: '', comment: 'Roll cage bracing configuration' }
    },
    safety: {
      ...
      fire_suit: { feature: '', comment: 'Fire suit rating' },
      cage_padding: { feature: '', comment: 'Roll cage padding placement' },
      fire_extinguisher: { feature: '', comment: 'Fire extinguisher mounting' }
    },
    performance: {
      top_speed: { feature: '', comment: 'Maximum speed achieved' },
      acceleration: { feature: '', comment: 'Acceleration performance' },
      braking: { feature: '', comment: 'Braking performance' },
      cornering: { feature: '', comment: 'Cornering performance' },
    ...
    notes: {
      ...
      tech_inspection: { feature: '', comment: 'Tech inspection requirements' }
    }
  };
  ...
  return (
    <div className="space-y-6">
      <div className="glass-panel p-6 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 dark:from-cyan-500/20 dark:to-blue-500/20">
        <div className="mb-6">
          <h1 className="text-3xl font-bold mb-4 text-cyan-600 dark:text-cyan-400">Caged Clone Class</h1>
          <p className="text-gray-700 dark:text-gray-300">
            The Caged Clone Class features karts with roll cages and clone engines, providing enhanced safety and competitive racing. 
            These machines combine the affordability of clone engines with additional safety features required for higher-speed competition. 
            Use our comprehensive setup tools to fine-tune your Caged Clone kart for optimal performance while maintaining safety standards.
          </p>
        </div>

        <div className="flex flex-col sm:flex-row gap-4 items-stretch">
          <LoadSetupsButton carType="caged-clone" onLoadSetup={handleLoadSetup} />
      ...
      <SetupSheet 
        title="Caged Clone Class"
        carType="caged-clone"
        description="Track and optimize your Caged Clone Class setup with our comprehensive setup sheet. Monitor chassis adjustments, engine settings, and safety features to maximize performance while ensuring compliance with class regulations."
        ...
        sections={[
          ...
          {
            title: "Chassis",
            fields: ["chassis_manufacturer", "chassis_year", "chassis_type", "wheelbase", "frame_stiffness", "cage_type"]
          },
          {
            title: "Weight",
            fields: ["total_weight", "left_side_weight", "rear_weight", "corner_weights", "lead_placement", "minimum_weight"]
          },
          {
            title: "Front End",
          ...
          {
            title: "Left Front",
            fields: ["lf_spring", "lf_shock", "lf_shock_compression", "lf_shock_rebound", "lf_ride_height", "lf_tire_compound", "lf_tire_pressure", "lf_wheel_type", "lf_camber", "lf_caster"]
          },
          {
            title: "Right Front",
            fields: ["rf_spring", "rf_shock", "rf_shock_compression", "rf_shock_rebound", "rf_ride_height", "rf_tire_compound", "rf_tire_pressure", "rf_wheel_type", "rf_camber", "rf_caster"]
          },
          {
            title: "Left Rear",
            fields: ["lr_spring", "lr_shock", "lr_shock_compression", "lr_shock_rebound", "lr_ride_height", "lr_tire_compound", "lr_tire_pressure", "lr_wheel_type"]
          },
          {
            title: "Right Rear",
            fields: ["rr_spring", "rr_shock", "rr_shock_compression", "rr_shock_rebound", "rr_ride_height", "rr_tire_compound", "rr_tire_pressure", "rr_wheel_type"]
          },
          {
            title: "Engine",
            fields: ["engine_builder", "engine_type", "displacement", "compression_ratio", "carburetor", "jetting", "timing", "spark_plug", "fuel_type", "exhaust", "air_filter", "cooling_system", "governor", "flywheel", "cam_profile"]
          },
          {
            title: "Drivetrain",
          ...
          },
          {
            ...
            fields: ["front_torsion_bar", "rear_torsion_bar", "third_bearing_support", "seat_struts", "side_rails", "cage_bracing"]
          },
          {
            title: "Safety",
            fields: ["seat_position", "belts_condition", "arm_restraints", "helmet_fit", "neck_brace", "chest_protector", "fire_suit", "cage_padding", "fire_extinguisher"]
          },
          {
            title: "Performance",
            fields: ["top_speed", "acceleration", "braking", "cornering", "lap_times"]
          },
          {
            title: "Notes",
            fields: ["track_notes", "setup_notes", "performance_notes", "maintenance_notes", "tech_inspection"]
          }
        ]}
      />
    </div>
...
export default CagedCloneClass;
