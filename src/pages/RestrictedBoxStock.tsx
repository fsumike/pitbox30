...
function RestrictedBoxStock() {
  ...
  // Define the setup data structure with Restricted Box Stock Kart specific sections
  const initialSetupData = {
    ...
    engine: {
      ...
      restrictor_plate: { feature: '', comment: 'Restrictor plate size' },
  ...
  return (
    <div className="space-y-6">
      <div className="glass-panel p-6 bg-gradient-to-br from-blue-500/10 to-purple-500/10 dark:from-blue-500/20 dark:to-purple-500/20">
        <div className="mb-6">
          <h1 className="text-3xl font-bold mb-4 text-blue-600 dark:text-blue-400">Restricted Box Stock Class Kart</h1>
          <p className="text-gray-700 dark:text-gray-300">
            Restricted Box Stock Class Karts are designed for youth racers, featuring sealed engines with restrictor plates to limit power and ensure safe, competitive racing. 
            These karts provide an excellent entry point into motorsports, teaching young drivers the fundamentals of racing while maintaining strict safety and performance standards.
            Use our comprehensive setup tools to fine-tune your Restricted Box Stock Kart for optimal performance within class regulations.
          </p>
        </div>

        <div className="flex flex-col sm:flex-row gap-4 items-stretch">
          <LoadSetupsButton carType="restricted-boxstock" onLoadSetup={handleLoadSetup} />
      ...
      <SetupSheet 
        title="Restricted Box Stock Kart"
        carType="restricted-boxstock"
        description="Track and optimize your Restricted Box Stock Kart setup with our comprehensive setup sheet. Monitor chassis adjustments, engine settings, and tire data to maximize performance while ensuring compliance with class regulations."
        ...
        sections={[
          ...
          {
            title: "Engine",
            fields: ["engine_builder", "engine_type", "restrictor_plate", "carburetor", "jetting", "timing", "spark_plug", "fuel_type", "exhaust"]
          },
          {
            title: "Drivetrain",
...
export default RestrictedBoxStock;
