...
function Intermediate250() {
  ...
  // Define the setup data structure with 250 Intermediate specific sections
  const initialSetupData = {
    ...
    engine: {
      ...
      engine_type: { feature: '', comment: 'Engine type (250cc 4-stroke)' },
  ...
  return (
    <div className="space-y-6">
      <div className="glass-panel p-6 bg-gradient-to-br from-indigo-500/10 to-violet-500/10 dark:from-indigo-500/20 dark:to-violet-500/20">
        <div className="mb-6">
          <h1 className="text-3xl font-bold mb-4 text-indigo-600 dark:text-indigo-400">250 Intermediate Class</h1>
          <p className="text-gray-700 dark:text-gray-300">
            The 250 Intermediate Class features 250cc four-stroke engines, offering a perfect balance of power and control for developing racers. 
            These machines combine lightweight chassis design with responsive handling characteristics, making them ideal for drivers transitioning 
            from beginner classes to more advanced racing. Use our comprehensive setup tools to fine-tune your 250 Intermediate for optimal performance 
            across various track conditions.
          </p>
        </div>

        <div className="flex flex-col sm:flex-row gap-4 items-stretch">
          <LoadSetupsButton carType="intermediate250" onLoadSetup={handleLoadSetup} />
      ...
      <SetupSheet 
        title="250 Intermediate Class"
        carType="intermediate250"
        description="Track and optimize your 250 Intermediate Class setup with our comprehensive setup sheet. Monitor chassis adjustments, engine settings, and suspension data to maximize performance and consistency on the track."
...
export default Intermediate250;
