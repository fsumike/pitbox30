            ...
            {distanceEnabled && selectedDistance && location.latitude && (
              <div className="mb-6 p-4 rounded-lg bg-gradient-to-r from-blue-100 to-cyan-100 dark:from-blue-900/30 dark:to-cyan-900/30 border border-blue-300 dark:border-blue-700 flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-lg bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 text-blue-900 dark:text-blue-100 font-medium transition-colors"
                >
                  Clear Filter
                </button>
              </div>
                ...
                >
                  ...
                  {showDeleteConfirm === listing.id && (
                    <div className="absolute inset-0 bg-black/70 flex items-center justify-center p-4">
                      <div className="bg-white dark:bg-gray-800 p-4 rounded-lg max-w-xs w-full">
            ...
            <div className="relative">
              ...
              <div className="mb-4">
                <img
                  ...
                  className="w-full h-auto object-cover rounded-lg max-h-24 md:max-h-32 mx-auto"
                />
              </div>
