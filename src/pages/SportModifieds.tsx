...
function SportModifieds() {
  ...
  // Define the setup data structure with Sport Modified specific sections
  const initialSetupData = {
    ...
    front_end: {
      ...
      spindle_type: { feature: '', comment: 'Spindle type' },
  ...
  return (
    <div className="space-y-6">
      <div className="glass-panel p-6 bg-gradient-to-br from-green-500/10 to-teal-500/10 dark:from-green-500/20 dark:to-teal-500/20">
        <div className="mb-6">
          <h1 className="text-3xl font-bold mb-4 text-green-600 dark:text-green-400">Sport Modifieds</h1>
          <p className="text-gray-700 dark:text-gray-300">
            Sport Modifieds (also known as B-Mods, Sport Mods, or Northern SportMods) are an entry-level modified class designed to be more affordable and accessible than full Modifieds. 
            ...
            Use our comprehensive setup tools to optimize your Sport Modified's performance while staying within class regulations.
          </p>
        </div>

        <div className="flex flex-col sm:flex-row gap-4 items-stretch">
          <LoadSetupsButton carType="sport-modified" onLoadSetup={handleLoadSetup} />
      ...
      <SetupSheet 
        title="Sport Modified"
        carType="sport-modified"
        description="Track and optimize your Sport Modified setup with our detailed setup sheet. Monitor chassis adjustments, suspension settings, and tire data while ensuring compliance with class rules and regulations."
