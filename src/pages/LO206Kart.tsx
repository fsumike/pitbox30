...
function LO206Kart() {
  ...
  // Define the setup data structure with LO206 Kart specific sections
  const initialSetupData = {
    ...
    engine: {
      ...
      engine_type: { feature: '', comment: 'Briggs & Stratton LO206' },
    ...
    safety: {
      ...
      rib_protector: { feature: '', comment: 'Rib protector type' }
    },
    notes: {
  ...
  return (
    <div className="space-y-6">
      <div className="glass-panel p-6 bg-gradient-to-br from-green-500/10 to-blue-500/10 dark:from-green-500/20 dark:to-blue-500/20">
        <div className="mb-6">
          <h1 className="text-3xl font-bold mb-4 text-green-600 dark:text-green-400">LO206 Kart</h1>
          <p className="text-gray-700 dark:text-gray-300">
            The Briggs & Stratton LO206 Kart class has become one of the most popular and accessible forms of karting across North America. 
            With a sealed engine package that emphasizes driver skill over equipment advantages, this class offers competitive racing at an affordable price point. 
            Use our comprehensive setup tools to fine-tune your LO206 kart's chassis and handling characteristics for optimal performance within class regulations.
          </p>
        </div>

        <div className="flex flex-col sm:flex-row gap-4 items-stretch">
          <LoadSetupsButton carType="lo206-kart" onLoadSetup={handleLoadSetup} />
      ...
      <SetupSheet 
        title="LO206 Kart"
        carType="lo206-kart"
        description="Track and optimize your LO206 Kart setup with our comprehensive setup sheet. Monitor chassis adjustments, weight distribution, and tire data to maximize performance while ensuring compliance with class regulations."
        ...
        sections={[
          ...
          {
            title: "Engine",
            fields: ["engine_builder", "engine_type", "carburetor", "jetting", "timing", "spark_plug", "fuel_type", "exhaust", "air_filter", "oil_type"]
          },
          {
            title: "Drivetrain",
          ...
          {
            title: "Safety",
            fields: ["seat_position", "belts_condition", "arm_restraints", "helmet_fit", "neck_brace", "chest_protector", "rib_protector"]
          },
          {
            title: "Notes",
