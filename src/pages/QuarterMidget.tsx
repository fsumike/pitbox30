  ...
  return (
    <div className="space-y-6">
      <div className="glass-panel p-6 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 dark:from-cyan-500/20 dark:to-blue-500/20">
        <div className="mb-6">
          <h1 className="text-3xl font-bold mb-4 text-cyan-600 dark:text-cyan-400">Quarter Midget Cars</h1>
          <p className="text-gray-700 dark:text-gray-300">
            Quarter Midget racing is designed specifically for children ages 5 to 16, providing a safe introduction to motorsports. 
            These scaled-down race cars feature safety-focused designs with roll cages and full suspension systems. 
            Use our comprehensive setup tools to help young drivers learn about car setup and improve their performance while maintaining safety as the top priority.
          </p>
        </div>

        <div className="flex flex-col sm:flex-row gap-4 items-stretch">
          <LoadSetupsButton carType="quarter" onLoadSetup={handleLoadSetup} />
      ...
      <SetupSheet 
        title="Quarter Midget"
        carType="quarter"
        description="Track and optimize your Quarter Midget car setup with our detailed setup sheet. Monitor engine parameters, chassis adjustments, and suspension settings to help young racers understand setup fundamentals and improve their performance while maintaining safety."
