...
import { CheckSquare, Square, Plus, Trash2, RotateCcw, Save, Loader2, AlertCircle, CheckCircle, Car, Settings, Clock, Wrench, Flag, X, ChevronDown, ChevronUp } from 'lucide-react';
  ...
  if (!user) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-xl font-semibold mb-2">Sign in to access maintenance checklists</h3>
        <p className="text-gray-600 dark:text-gray-400">
          Keep your race car in top condition with customized checklists
        </p>
      </div>
    );
  }
